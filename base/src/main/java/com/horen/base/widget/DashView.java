...
public class DashView extends View {
    ...
    public DashView(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.ServiceDashView);
        dashWidth = typedArray.getDimension(R.styleable.ServiceDashView_service_dashWidth, DEFAULT_DASH_WIDTH);
        lineHeight = typedArray.getDimension(R.styleable.ServiceDashView_service_lineHeight, DEFAULT_LINE_HEIGHT);
        lineWidth = typedArray.getDimension(R.styleable.ServiceDashView_service_lineWidth, DEFAULT_LINE_WIDTH);
        lineColor = typedArray.getColor(R.styleable.ServiceDashView_service_lineColor, DEFAULT_LINE_COLOR);
        dashOrientation = typedArray.getInteger(R.styleable.ServiceDashView_service_dashOrientation, DEFAULT_DASH_ORIENTATION);
