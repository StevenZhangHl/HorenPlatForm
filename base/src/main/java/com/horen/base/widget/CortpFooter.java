...
public class CortpFooter extends RelativeLayout implements RefreshFooter {
    ...
    private void initView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTitleText.setTextColor(Color.parseColor("#666666"));
        ...
        LayoutParams lpArrow = new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        ...
        if (ta.hasValue(R.styleable.ClassicsFooter_srlDrawableArrow)) {
            ...
            mArrowView.setImageResource(R.drawable.ic_load_more);
        }
     ...
     * 设置已完成文字
     */
    public void setLoadCompleteText(@StringRes int idRes) {
        REFRESH_FOOTER_ALLLOADED = BaseApp.getAppResources().getString(idRes);
    }
