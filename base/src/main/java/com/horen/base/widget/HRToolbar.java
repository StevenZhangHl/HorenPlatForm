...
public class HRToolbar extends FrameLayout {
     ...
     * 初始化Toolbar
     */
    public void bindActivity(final AppCompatActivity activity, @DrawableRes int closeIcon) {
        initToolbar(activity, closeIcon);
    }
    ...
    public void bindActivity(final AppCompatActivity activity) {
        initToolbar(activity, 0);
    }

    /**
     * 白色状态栏
     */
    public void bindActivityForWhite(final AppCompatActivity activity, @DrawableRes int closeIcon) {
        bindActivity(activity, R.color.white, closeIcon);
    }
    ...
    public void bindActivityForWhite(final AppCompatActivity activity) {
        bindActivity(activity, R.color.white, 0);
    }

    /**
     * 设置白色或者灰色状态栏
     */
    public void bindActivity(final AppCompatActivity activity, @ColorRes int statusColor, @DrawableRes int closeIcon) {
        setBackgroundResource(statusColor);
        // 版本大于6.0 改变状态栏文字颜色
     ...
     * 初始化Toolbar
     */
    private void initToolbar(final AppCompatActivity activity, @DrawableRes int closeIcon) {
        ...
        if (closeIcon != 0) {
            ...
            lp.setMargins(DisplayUtil.dip2px(mContent, 5), 0, 0, 0);
