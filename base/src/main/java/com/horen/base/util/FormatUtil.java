...
public class FormatUtil {
    ...
    /**
     * 格式化箱号，成010102006 004229格式
     */
    public static String formatBoxNumber(String boxNumber) {
        StringBuilder sb = new StringBuilder(boxNumber);
        sb.insert(9, " ");
        return sb.toString();
    }
     ...
     * 字符串中间是否包含空格
     */
    public static boolean isContainSpaces(String boxNumber) {
        return boxNumber.contains(" ");
    }
