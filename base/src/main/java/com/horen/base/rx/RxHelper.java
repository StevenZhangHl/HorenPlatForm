...
//     * Rx优雅处理服务器返回
//     */
//    public static <T extends BaseEntry, R> ObservableTransformer<T, R> transform(final Class<R> rClass) {
//        return new ObservableTransformer<T, R>() {
//            @Override
//            public Observable<R> apply(Observable<T> upstream) {
//                return upstream.flatMap(new Function<T, Observable<R>>() {
//                    @Override
//                    public Observable<R> apply(T entry) throws Exception {
//                        if (entry.success()) {
//                            Gson gson = new Gson();
//                            String json = gson.toJson(entry.getDataResponse());
//                            // 字节码转换bean对象
//                            R data = gson.fromJson(json, rClass);
//                            // 得到bean对象Observable
