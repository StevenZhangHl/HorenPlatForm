 ...
 */
public class BaseFAdapter extends FragmentPagerAdapter {

    List<Fragment> fragmentList = new ArrayList<Fragment>();
    private List<String> mTitles;
    private String[] mTitless;

    public BaseFAdapter(FragmentManager fm, List<Fragment> fragmentList) {
        super(fm);
        this.fragmentList = fragmentList;
    }

    public BaseFAdapter(FragmentManager fm, List<Fragment> fragmentList, String[] mTitless) {
        super(fm);
        this.fragmentList = fragmentList;
        this.mTitless = mTitless;
    }

    public BaseFAdapter(FragmentManager fm, List<Fragment> fragmentList, List<String> mTitles) {
        super(fm);
