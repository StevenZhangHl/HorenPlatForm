...
import com.horen.service.ui.activity.adapter.RepairCompleteAdapter;
 ...
 */
public class RepairCompleteActivity extends BaseActivity implements OnRefreshLoadMoreListener {
    ...
    private RepairCompleteAdapter completeAdapter;

    public static void startActivity(Context context, ServiceListBean.ServiceBean bean) {
        Intent intent = new Intent();
        intent.putExtra("bean", bean);
        intent.setClass(context, RepairCompleteActivity.class);
        context.startActivity(intent);
    }

    @Override
    public int getLayoutId() {
        return R.layout.service_activity_repair_complete;
    }
    ...
    public void initView(Bundle savedInstanceState) {
        ...
        // 维修总量
        mTvRepairTotal.setText(String.format(mContext.getString(R.string.service_repair_total), String.valueOf(bean.getService_qty())));
        // 获取数据
        initData(true);
    }
    ...
    private void initRecyclerView() {
        ...
        completeAdapter = new RepairCompleteAdapter(R.layout.service_item_repair_complete);
    ...
    private void initData(boolean isShowDialog) {
        ...
        mRxManager.add(Api.getInstance()
                .getServiceRtpInfo(ServiceParams.getServiceRtpInfo(pageNum, pageSize, bean.getProduct_id(), "4", ServiceType.REPAIR.getStatus()))
                ...
                .subscribeWith(new BaseObserver<RepairListDetailBean>(mContext, isShowDialog) {
                    ...
                    protected void onSuccess(RepairListDetailBean detailBean) {
                        // 加载更多
                        if (pageNum > 1) {
                            completeAdapter.addData(detailBean.getPageInfo().getList());
                            ...
                            if (CollectionUtils.isNullOrEmpty(detailBean.getPageInfo().getList())) {
                                ...
                                completeAdapter.setNewData(detailBean.getPageInfo().getList());
                            }
