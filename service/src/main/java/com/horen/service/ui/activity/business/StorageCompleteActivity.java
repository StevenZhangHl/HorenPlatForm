 ...
 */
public class StorageCompleteActivity extends BaseActivity<BusinessPresenter, BusinessModel> implements BusinessContract.View {
    ...
    public static void startActivity(Context context, String order_type, String orderallot_id) {
        ...
        intent.setClass(context, StorageCompleteActivity.class);
        context.startActivity(intent);
    }

    @Override
    public int getLayoutId() {
        return R.layout.service_activity_storage_complete_detail;
    }
