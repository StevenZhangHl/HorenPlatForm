 ...
 */
public class BillMainAdapter extends BaseQuickAdapter<BillMainBean.BillListBean, BaseViewHolder> {
    public BillMainAdapter(@Nullable List<BillMainBean.BillListBean> data) {
        super(R.layout.service_item_bill_main, data);
    }
    ...
    protected void convert(BaseViewHolder helper, BillMainBean.BillListBean item) {
        ...
        // 未付
        helper.setText(R.id.tv_outstanding_money, NumberUtil.formitNumberTwoPoint(Double.valueOf(item.getDiff_amt())));
        // 时间
