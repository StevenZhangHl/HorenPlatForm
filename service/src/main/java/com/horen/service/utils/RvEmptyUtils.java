...
public class RvEmptyUtils {
    ...
    public static void setEmptyView(BaseQuickAdapter adapter, RecyclerView recyclerView) {
        ...
        adapter.setEmptyView(R.layout.service_layout_empty, (ViewGroup) recyclerView.getParent());
    }
    ...
    public static void setEmptyView(BaseQuickAdapter adapter, RecyclerView recyclerView, String msg) {
        View view = LayoutInflater.from(recyclerView.getContext()).inflate(R.layout.service_layout_empty, null);
        TextView textView = view.findViewById(R.id.tv_no_date);
